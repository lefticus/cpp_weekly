...
class Automata:
    width: int
    height: int
    born: tuple[bool,bool,bool,bool,bool,bool,bool,bool,bool]
    ...
    def index(self, p : Point):
        return modulo(p.y, self.height) * self.width + modulo(p.x, self.width)
...
obj = Automata(40, 20, (False, False, False, True, False, False, False, False, False),
